# Partner Enablement Kit (The "Facilitator Box")

**Partner Role:** Commercial Facilitator
**Your Role:** IP Owner & Tech Provider

## 1. The Proposition (Email to send her)
*Subject: The AI-ESG Facilitator Opportunity*
...
## 3. The Commercial Model (Suggestion)
*   **Workshop Fee:** $3k - $5k per day.
    *   *Split:* 70% to Her (Delivery), 30% to You (Licensing).
*   **Software Licensing (GrieVoice):**
    *   *Split:* 20% Commission to Her (Sales), 80% to You (SaaS Owner).

## 4. Immediate 'To-Do' for Partner
*   **Action:** Ask her to identify **ONE** client who trusts her enough to run a "Beta Workshop" for free or low cost to test the flow.
